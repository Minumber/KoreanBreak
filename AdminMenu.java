...
public class AdminMenu extends JFrame {
	...
	public AdminMenu() {
		...
		button_1.setBounds(144, 338, 100, 30);
		...
		button_4.setBounds(12, 338, 100, 30);
		...
		button_5.setBounds(284, 338, 100, 30);
		...
		button_6.setBounds(12, 378, 100, 30);
		getContentPane().add(button_6);
		
		JButton button_7 = new JButton("생활관관리");
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new AdminDormitoryUpdate();
			}
		});
		button_7.setFont(new Font("굴림", Font.PLAIN, 10));
		button_7.setBounds(144, 378, 100, 30);
